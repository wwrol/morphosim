...
def run_sim():
    ...
    groupA = mps.add_group("a",Ptype.A,25,0.2)
    groupA.add_source(x0-spacer,200,MAX_PART//2)
    groupB = mps.add_group("b",Ptype.B,7.5,0.01)
    groupB.add_source(x0+spacer,200,MAX_PART//2)
    groupC = mps.add_group("c",Ptype.C,2,0.1)
    ...
    while running:
        ...
        mps.step(dt)
        mps.update_group_inter("a","b","c",50)
